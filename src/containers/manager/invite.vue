		...
		<div v-show="isAppleSure">
			...
			<div class="inviteCell">
				<div class="inviteCellOut">
					...
					<div class="cellRight">
						<input type="tel" pattern="[0-9]*" v-on:input ="clearMoreCode()" placeholder="请输入手机号" v-model="setTelNum"/>
					</div>
				</div>
			</div>
			<div class="inviteCell">
			...
			<div class="inviteCell">
				<div class="inviteCellOut">
					...
					<div class="cellRight">
						<input type="tel" placeholder="请输入真实姓名" v-model="realName"/>
					</div>
				</div>
			</div>
			...
			<div class="bot" @click="applyManager">
				<p><span>提交申请</span></p>
			</div>
